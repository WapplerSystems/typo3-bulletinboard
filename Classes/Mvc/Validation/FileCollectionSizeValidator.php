...
namespace WapplerSystems\WsBulletinboard\Mvc\Validation;
 ...
 * @internal
 */
class FileCollectionSizeValidator extends AbstractValidator
{
    /**
     * @var array
     */
     ...
     */
  protected function isValid(mixed $resources): void
    {
